    ...
    <div className="">
      ...
      {dataSource ? (
        <>
          <div className="flex items-center justify-center">
            <table border={2} className="border-2 dark:border-white">
              <thead className="border-2  dark:border-white">
                <tr className="border-2  dark:border-white">
                  <th className="border-2  dark:border-white">Group</th>
                  <th className="border-2  dark:border-white">Name</th>
                  <th className="border-2  dark:border-white">Total</th>
                  <th className="border-2  dark:border-white">V</th>
                  <th className="border-2  dark:border-white">C</th>
                </tr>
              </thead>
        ...
        <>
          ...
          <Image
            className="container justify-center align-middle items-center"
            src={"/images/up.png"}
