            ...
            >
              <thead className="border-2  dark:border-white border-black p-[20px]">
                <tr className="border-2  dark:border-white border-black">
                  <th className="border-2  dark:border-white border-black text-blue-600 font-[900]">
                    Grp.
                  </th>
                  <th className="border-2  dark:border-white border-black text-blue-600 font-[900]">
                    Name
                  ...
                  <th className="border-2 px-[10px]  dark:border-white border-black text-blue-600 font-[900]">
                    V
                  </th>
                  <th className="border-2 px-[10px]  dark:border-white border-black text-blue-600 font-[900]">
                    C
              ...
              <tbody className="border-2  dark:border-white border-black text-[#0CC0DF] font-[900]">
                <tr className="border-2  dark:border-white border-black">
