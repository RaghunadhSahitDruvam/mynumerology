            ...
            >
              <thead className="border-2  dark:border-white border-pink-600 p-[20px]">
                <tr className="border-2  dark:border-white border-pink-600">
                  <th className="border-2  dark:border-white border-pink-600 bg-green-600 text-white  text-2xl font-[900]">
                    Grp.
                  </th>
                  <th className="border-2  dark:border-white border-pink-600 bg-green-600 text-white  text-2xl font-[900]">
                    Name
                  ...
                  <th className="border-2 px-[10px]  dark:border-white border-pink-600 bg-green-600 text-white  text-2xl font-[900]">
                    V
                  </th>
                  <th className="border-2 px-[10px]  dark:border-white border-pink-600 bg-green-600 text-white  text-2xl font-[900] text-2xl">
                    C
                  </th>
                </tr>
              </thead>
              <tbody className="border-2  dark:border-white border-pink-600 text-[#960084] font-[900]">
                <tr className="border-2  dark:border-white border-pink-600">
                  <td className="border-2  dark:border-white border-pink-600 bg-green-600 text-white  text-2xl ">
                    C
                  </td>
                  ...
                  <td className="border-2  dark:border-white border-pink-600 text-2xl bg-green-600 text-white ">
                    {dataSource?.g2tot}
                  </td>
                  <td className="border-2  dark:border-white border-pink-600 text-2xl bg-green-600 text-white ">
                    {" "}
