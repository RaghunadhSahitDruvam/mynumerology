    ...
    <div className="">
      ...
      <div>
        ...
        >
          ...
          />
          {textName && ( // Display clear button only when there is text
            <button
              type="button"
              className="flex items-center justify-center p-1 ml-2 rounded-md bg-gray-200 hover:bg-gray-300 focus:outline-none"
              // onClick={clearInput}
            >
              X
            </button>
