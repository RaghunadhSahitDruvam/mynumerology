      ...
      {dataSource ? (
        <>
            ...
            >
              <thead className="border-2  dark:border-white border-black p-[20px]">
                <tr className="border-2  dark:border-white border-black">
                  <th className="border-2  dark:border-white border-black text-blue-600 text-2xl font-[900]">
                    Grp.
                  </th>
                  <th className="border-2  dark:border-white border-black text-blue-600 text-2xl font-[900]">
                    Name
                  ...
                  <th className="border-2 px-[10px]  dark:border-white border-black text-blue-600 text-2xl font-[900]">
                    V
                  </th>
                  <th className="border-2 px-[10px]  dark:border-white border-black text-blue-600 text-2xl font-[900] text-2xl">
                    C
                  </th>
                </tr>
              </thead>
              <tbody className="border-2  dark:border-white border-black text-[#960084] font-[900]">
                <tr className="border-2  dark:border-white border-black">
                  <td className="border-2  dark:border-white border-black text-blue-600 text-2xl text-2xl">
                    C
                  </td>
                  ...
                  <td className="border-2  dark:border-white border-black text-2xl">
                    {dataSource?.g2tot}
                  </td>
                  <td className="border-2  dark:border-white border-black text-2xl">
                    {" "}
                ...
                <tr className="border-2  dark:border-white border-black">
                  <td className="border-2  dark:border-white border-black text-blue-600 text-2xl ">
                    P
                  </td>
                  <td className=" border-2  dark:border-white border-black">
                    <table
          ...
          <div className="container flex  items-start mt-[10px] justify-between">
            {" "}
            <span className="text-blue-600 text-2xl font-[900]">
