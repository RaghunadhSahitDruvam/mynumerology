      ...
      {dataSource ? (
        <>
          <div className="container mt-[30px] flex items-start justify-start">
            <table
              border={2}
              className="border-2 dark:border-white border-orange-600"
            >
              <thead className="border-2  dark:border-white border-orange-600 p-[20px]">
                <tr className="border-2  dark:border-white border-orange-600">
                  <th className="border-2  dark:border-white border-orange-600 bg-green-600 text-white  text-2xl font-[900]">
                    Grp.
                  </th>
                  <th className="border-2  dark:border-white border-orange-600 bg-green-600 text-white  text-2xl font-[900]">
                    Name
                  ...
                  <th className="border-2 px-[10px]  dark:border-white border-orange-600 bg-green-600 text-white  text-2xl font-[900]">
                    V
                  </th>
                  <th className="border-2 px-[10px]  dark:border-white border-orange-600 bg-green-600 text-white  text-2xl font-[900] text-2xl">
                    C
                  </th>
                </tr>
              </thead>
              <tbody className="border-2  dark:border-white border-orange-600 text-[#960084] font-[900]">
                <tr className="border-2  dark:border-white border-orange-600">
                  <td className="border-2  dark:border-white border-orange-600 bg-green-600 text-white  text-2xl ">
                    C
                  </td>
                  <td className=" border-2  dark:border-white border-orange-600 ">
                    <table
                  ...
                  <td className="border-2  dark:border-white border-orange-600 text-2xl bg-green-600 text-white ">
                    {dataSource?.g2tot}
                  </td>
                  <td className="border-2  dark:border-white border-orange-600 text-2xl bg-green-600 text-white ">
                    {" "}
