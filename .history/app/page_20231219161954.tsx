...
const Page: React.FC = () => {
  ...
  const handleInputChange = () => {
    const newValue = inputFocusRef.current?.value || "";
  ...
  return (
    <div className="">
      ...
      <div>
        <div className="container gap flex justify-between">
          <Input
            type="text"
            placeholder="Name"
            className="w-[70%]"
            value={textName}
            ref={inputFocusRef} // Attach the ref to the input element
            onChange={handleInputChange} // Use the ref's current value
          />
        </div>
      </div>
      {dataSource ? (
